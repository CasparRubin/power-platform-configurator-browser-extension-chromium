      ...
      <section className={SETTINGS_SECTION_CLASS}>
        ...
        >
          <SettingsChoiceRow
            ...
            description={<code className={SETTINGS_CODE_CLASS}>v3=false</code>}
          />
          <SettingsChoiceRow
            id="mode-true"
            value="true"
            selected={value === "true"}
            label="New Designer"
            description={<code className={SETTINGS_CODE_CLASS}>v3=true</code>}
          />
          <SettingsChoiceRow
            id="mode-off"
            value="off"
          ...
          description={
            <span className="flex flex-col gap-1">
              ...
              <span>
                ...
                applies when <code className={SETTINGS_CODE_CLASS}>v3survey</code> is already on the
                URL: it is normalized to <code className={SETTINGS_CODE_CLASS}>v3survey=true</code>.
                Nothing is added if the flag is missing. Reload the flow or run page after changing
                this when enforcement is not paused.
              </span>
            </span>
          }
        />
          ...
          <SettingsChoiceRow
            ...
            description={
              <>
                ...
                normalize it to <code className={SETTINGS_CODE_CLASS}>true</code>. Does not add the
